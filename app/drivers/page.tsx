        ...
        <main className="flex-1 p-4 sm:p-6 mt-[73px] lg:ml-64 w-full lg:w-[calc(100%-16rem)] overflow-visible relative z-auto">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2">
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Водители</h1>
                <p className="text-sm sm:text-base text-gray-600 mt-1">Управление зарегистрированными водителями такси</p>
              </div>
            </div>
